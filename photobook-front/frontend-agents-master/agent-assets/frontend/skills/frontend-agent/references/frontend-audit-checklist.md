...
- Offline browser state renders a non-blocking connection/synchronization status
  and clears when connection returns. Only network-required actions may block.
